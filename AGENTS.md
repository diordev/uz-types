...
This file contains instructions for working with the code from this repository in the Codex, ChatGPT.
...
> **Kod yozishdan oldin:** `.codex/skills/idiomatic-rust/SKILL.md` ni o'qing — bu repodagi
