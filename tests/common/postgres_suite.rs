// Jonli PostgreSQL suite tanasi — `tests/sqlx_postgres.rs` (0.9) va
// `tests/sqlx_postgres_0_8.rs` (0.8) uni `include!` qiladi. Har ikkala test
// crate'i o'z sqlx versiyasini root'da `extern crate ... as sqlx;` bilan
// nomlaydi, chunki `#[sqlx::test]` proc-makrosi ichida `::sqlx::` yo'llarini
// generatsiya qiladi va lokal `use` aliasi unga yetmaydi.
...
#[ignore = "jonli PostgreSQL: `just postgres-test` yoki `just postgres-test-08`"]
